...
<div class="property-card-box card-box card-block" style="height: 170px !important;">
    <h3 class="property-card-title"><a href="<?php echo $generales->url_base; ?>hogares/hogar-venus.php">Hogar Venus</a></h3>
    <div class="property-card-descr">
        Av. Campo Blasones #36 Fracc. Campo Real, Zapopan, Jal.
    </div> <br>
