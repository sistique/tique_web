...
<div class="property-card-box card-box card-block" style="height: 170px !important;">
    <h3 class="property-card-title"><a href="<?php echo $generales->url_base; ?>hogares/lote-xaman.php">Lote Xaman</a></h3>
    <div class="property-card-descr">
        P.º del Puma 3064, Ciudad Bugambilias, 45237 Zapopan, Jal.
