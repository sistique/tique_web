...
<div class="col-md-4 col-sm-6">
    <div class="property-card card">
        <div class="property-card-header image-box">
            <img src="<?php echo $generales->url_base;?>assets/img/venta_casas/lote_yaax/1/lote_yaax1.png" alt="" class="" />
            ...
            <a href="<?php echo $generales->url_base; ?>hogares/lote-yaax.php" class="property-card-hover">
                ...
                <span id='imagen 1' onclick='getlinkYaax()'>
