...
<div class="property-card-box card-box card-block" style="height: 170px !important;">
    <h3 class="property-card-title"><a href="<?php echo $generales->url_base; ?>hogares/hogar-araucaria.php">Hogar Araucaria</a></h3>
    <div class="property-card-descr">
        Real de las Araucarias 1323 M 46-2, Fracc. Camichines Residencial, Tlaquepaque, Jal.    </div>
    <br>
