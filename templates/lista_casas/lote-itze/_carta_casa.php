...
<div class="col-md-4 col-sm-6">
    <div class="property-card card">
        <div class="property-card-header image-box">
            <img src="<?php echo $generales->url_base;?>assets/img/venta_casas/lote_itze/1/lote_itze1.png" alt="" class="" />
            <!--Casa destacada en caso de serlo-->
            <!--<div class="budget"><i class="fa fa-star"></i></div>-->
            <a href="<?php echo $generales->url_base; ?>hogares/lote-itze.php" class="property-card-hover">
                ...
                <span id='imagen 1' onclick='getlinkItze()'>
        ...
        <?php include $generales->path_base.'templates/lista_casas/lote-itze/_carta_casa_detalles.php' ?>
    </div>
</div>
<script>//<![CDATA[
    function getlinkItze() {
        var aux = document.createElement("input");
        aux.setAttribute("value","<?php echo $generales->url_base; ?>hogares/lote-itze.php");
