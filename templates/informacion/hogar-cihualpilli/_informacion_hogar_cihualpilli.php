        ...
        <div class="box-container widget-body">
            ...
            <div class="form-additional">
                ...
                <div class="form-group" hidden>
                    <input type="text" name="hogar" class="form-control" placeholder="Hogar" value=" Hogar Cihualpilli" />
                </div>
                <div class="form-group" hidden>
                    <input type="text" name="url_redireccion" class="form-control" placeholder="Hogar" value="hogar-cihualpilli.php" />
                </div>
