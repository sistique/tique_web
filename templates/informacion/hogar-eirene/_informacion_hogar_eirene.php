        ...
        <div class="box-container widget-body">
            ...
            <div class="form-additional">
                ...
                <div class="form-group" hidden>
                    <input type="text" name="hogar" class="form-control" placeholder="Hogar" value=" Hogar Eirene" />
                </div>
                <div class="form-group" hidden>
                    <input type="text" name="url_redireccion" class="form-control" placeholder="Hogar" value="hogar-eirene.php" />
                </div>
