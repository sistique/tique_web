<?php
    $a = $generales->url_base."assets/img/venta_casas/hogar_eden/1Fachada/29.jpg";
    $b = $generales->url_base."assets/img/venta_casas/hogar_eden/2Sala/31.jpg";
    $c = $generales->url_base."assets/img/venta_casas/hogar_eden/8Entorno/25.jpg";
?>
