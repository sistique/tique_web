...
<div class="widget-body">
    ...
    <div class="widget-content wide-p">
        <img src="<?php echo $generales->url_base;?>assets/img/venta_casas/hogar_teva/1Fachada/img1.jpg""  class="pull-right-img" alt="" />
    ...
    <font size="2" style="font-size: 10pt">
        Hogar Teva bonita vivienda que se encuentra dentro del Fraccionamiento Residencial Campo Real ubicado en el  Municipio de Zapopan, Jalisco, esta vivienda se caracteriza por su confort y su amplia distribución y construcción, hogar Teva tiene una ubicación excepcional rodeada de extensas áreas verdes, dentro del fraccionamiento se encuentran parques lineales y su bonito lago artificial. Hogar Teva es ideal para la convivencia y recreación familiar ya que cuenta con canchas deportivas, terraza familiar.

    </font></p>
    <p align="justify" style="margin-bottom: 0cm"> </p>
        <p align="justify" style="text-indent: 1.27cm; margin-bottom: 0cm"><font size="2" style="font-size: 10pt">
            Hogar Teva cuenta con dos niveles, en la planta baja se encuentra 1/2 baño, cocina, comedor, sala, patio trasero de servicio, jardín y cochera para dos vehículos, en la planta alta tenemos un 3 recámaras, y 2 baños completos distribuidas de la siguiente manera, 2 recamaras, 1 baño compartido para ambas recamaras, 1 recamara principal con su baño completo y vestidor.
    ...
    <p align="justify" style="text-indent: 1.27cm; margin-bottom: 0cm"><font size="2" style="font-size: 10pt">
        A tan solo 5 minutos de la Av. Juan Gil Preciado.
    </font>
    </p>
