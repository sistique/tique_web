...
<div class="widget-body">
    ...
    <div class="widget-content wide-p">
        <img src="<?php echo $generales->url_base;?>assets/img/venta_casas/hogar_araucaria/1Fachada/fachada_1.jpg""  class="pull-right-img" alt="" />
        ...
        <body link="#000080" vlink="#800000" dir="ltr"><p align="justify" style="text-indent: 1.27cm; margin-bottom: 0cm">
            <font size="2" style="font-size: 10pt">
                ...
                Hogar Araucaria es una vivienda con una ubicación excelente ubicada al oriente del Área Metropolitana de Guadalajara, esta agradable vivienda se encuentra en el Fracc. Camichines Residencial del Mpio de Tlaquepaque, Jalisco, esta vivienda se caracteriza por su confort y su amplia distribución y construcción, Hogar Araucaria es una excelente oportunidad para ti y tu familia.
            </font></p>
        <p align="justify" style="margin-bottom: 0cm"> </p>
        <p align="justify" style="text-indent: 1.27cm; margin-bottom: 0cm"><font size="2" style="font-size: 10pt">
                Hogar Araucaria es una casa Duplex en la planta alta con la siguiente distribución sala, comedor, cocina, 1 baño, patio de servicio y cochera.            </font></p>
        <p align="justify" style="margin-bottom: 0cm">

        </p>
        <p align="justify" style="text-indent: 1.27cm; margin-bottom: 0cm"><font size="2" style="font-size: 10pt">
                Llegar es fácil, ya que tiene una excelente ubicación, cercanía y acceso con diversas vialidades principales de la ciudad cómo lo son Calzada Lazaro Cardenas, Carretera Libre a Zapotlanejo, autopista a Zapotlanejo.
                Dada su ubicación esta vivienda cuenta con todos los servicios para una buena calidad de vida, hospitales, escuelas, tiendas de autoservicio, unidad deportiva  para vivir en armonía.            </font>
        </p>
