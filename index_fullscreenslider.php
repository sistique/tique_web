                        ...
                        <div id="header-slider" class="carousel slide slider-tall slider-full-height" data-ride="carousel">
                            ...
                            <ol class="carousel-indicators">
                                <li data-target="#header-slider" data-slide-to="0" class="active">
                                    <div class="carousel-indicators-preview"></div>
                                </li>
                            ...
                            <div class="carousel-inner" role="listbox">
                                ...
                                <div class="item active">
                                    <img src="assets/img/placeholders/1700x1200.png" alt="Sunset over beach" />
                                ...
                                <!-- Slide 2 -->
                                <div class="item">
                                    <img src="assets/img/placeholders/1700x1200.png" alt="Rob Roy Glacier" />
                                    <div class="carousel-caption">
                                        <h3 class="carousel-caption-title"><span>Single Property real estate</span><i class="line-bottom color-primary"></i></h3>
                                        <div class="s-description"><p>This is simply dummy text of the printing and the typesetting industry. That has been the industry standard dummy text ever since the 1500s ...</p></div>
                                        <a href="listing.html" class="btn btn-primary color-primary"><span>Click to show</span></a>
                                ...
                                <!-- Slide 3 -->
                                <div class="item">
                                    <img src="assets/img/placeholders/1700x1200.png" alt="Longtail boats at Phi Phi" />
                                    <div class="carousel-caption">
                                        <h3 class="carousel-caption-title"><span>Single Property real estate</span> <i class="line-bottom color-primary"></i></h3>
                                        <div class="s-description"><p>This is simply dummy text of the printing and the typesetting industry. That has been the industry standard dummy text ever since the 1500s ...</p></div>
                                        <a href="listing.html" class="btn btn-primary color-primary"><span>Click to show</span></a>
                            ...
                            <div class="h-side top-pad h-side-slim clearfix">
                                <div class="properties-filter">
                                    ...
                                    <div class="grid-type pull-right">
                                        <a href="index_fullscreenslider.html" class="grid active"><i class="fa fa-th"></i></a>
