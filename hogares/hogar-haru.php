            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="widget widget-box box-container widget-property">
                        ...
                        <?php include $generales->path_base.'templates/descripcion/_descripcion_general_haru.php' ?>
                    </div> <!-- /. widget-body -->
                    ...
                    <?php include $generales->path_base.'templates/galeria/hogar-haru/_galeria_hogar.php' ?>
