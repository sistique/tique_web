...
$descripcion_twitter = 'Hogar Olivo es una Casa Habitación de un nivel que se distribuye de la siguiente manera, tenemos su Sala, Comedor, Cocina, 2 recamaras, 1 baño completo, patio trasero de servicio y cuenta con su propia cochera para un auto.'; //falta por automatizar
?>
    <!DOCTYPE html>
    <html lang="en">
<head>
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="widget widget-box box-container widget-property">
                        <?php include $generales->path_base.'templates/sliders/hogar_olivo/_slider_hogar_olivo.php' ?>
                        <?php include $generales->path_base.'templates/descripcion/hogar-olivo/_descripcion_hogar_olivo.php' ?>
                    </div> <!-- /. widget-body -->
                    ...
                    <?php include $generales->path_base.'templates/galeria/hogar-olivo/_galeria_hogar.php' ?>
                ...
                <div class="col-md-3">
                    ...
                    <a href='<?php echo $generales->url_base; ?>hogares/vista-impresion/vista-impresion-hogar-olivo.php '<?php echo $url_landing_limpia?>' class="btn btn-primary color-primary btn-property btn-print">Vista de impresión</a>
