...
$descripcion_twitter = 'Espectacular oportunidad de terreno para inversión o para construir tu patrimonio, gran potencial para desarrollar una casa residencial en el Fraccionamiento más exclusivo de la Zona Sur de la Ciudad espacio ideal para que tú y tu familia gocen al máximo, tiene una excelente ubicación este bonito terreno en el Fracc. El Palomar. El terreno incluye proyecto arquitectónico original desarrollado para el terreno. Disfruta de la armonía y del aire fresco del bosque en tu hogar. '; //falta por automatizar
?>
<!DOCTYPE html>
<html lang="en">
<head>
