...
$descripcion_twitter = '    Se vende bonita casa en Coto Privado en Colinas del Rey Zapopan, el Inmueble cuenta con 2 niveles distribuida de la siguiente manera en planta baja se cuenta con Cochera, Sala, Comedor, Cocina, 1 Recámara, 1 baño completo, patio.
En Planta Alta 1 recámara, cuenta con una ubicación magnífica cerca de Av. Principales como son Av. Juan Gil Preciado, Av. Valdepeñas está muy cercano a la línea 3 del Tren Ligero.
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="widget widget-box box-container widget-property">
                        <?php include $generales->path_base.'templates/sliders/hogar_girasol/_slider_hogar_girasol.php' ?>
                        <?php include $generales->path_base.'templates/descripcion/hogar-girasol/_descripcion_hogar_girasol.php' ?>
                    </div> <!-- /. widget-body -->
                    ...
                    <?php include $generales->path_base.'templates/galeria/hogar-girasol/_galeria_hogar.php' ?>
                ...
                <div class="col-md-3">
                    ...
                    <a href='<?php echo $generales->url_base; ?>hogares/vista-impresion/vista-impresion-hogar-girasol.php '<?php echo $url_landing_limpia?>' class="btn btn-primary color-primary btn-property btn-print">Vista de impresión</a>
