...
$descripcion_twitter = 'Hogar KETZALY excelente casa ubicada en una excelente zona al oriente de la Ciudad de Guadalajara Jalisco, en una colonia muy tranquila, la vivienda es ideal para el bienestar de su familia por su tranquilidad y comodidad para poder vivir, Hogar KETZALY cuenta con fácil acceso por su excelente ubicación a principales Avenidas de la Ciudad cómo son Av. Circunvalación Oblatos, Calzada Juan Pablo Segundo, Calzada Independencia, fácil acceso a escuelas, hospitales,  parques de recreación familiar y centros comerciales.';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <meta property='twitter:image' content="<?php echo $generales->url_base; ?>assets/img/venta_casas/hogar_ketzaly/1Fachada/fachada_1.jpg"/>
    <meta property="og:description" content="Hogar KETZALY es una Casa Habitación de dos niveles que se distribuye de la siguiente manera, en la planta baja tenemos su Sala, Comedor, Cocina, ½ Baño, cuarto de lavado, estudio, patio/ jardín y cochera para 2 vehículos en la planta alta se cuenta con 3 recámaras con baño completo, pequeña sala de estar." />
...
<body class="">
<img src="<?php echo $generales->url_base; ?>assets/img/venta_casas/hogar_ketzaly/1Fachada/fachada_1.jpg" hidden>
<div id="fb-root"></div>
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="widget widget-box box-container widget-property">
                        <?php include $generales->path_base.'templates/sliders/hogar-ketzaly/_slider_hogar_ketzaly.php' ?>
                        <?php include $generales->path_base.'templates/descripcion/hogar-ketzaly/_descripcion_hogar_ketzaly.php' ?>
                    </div> <!-- /. widget-body -->
                    <?php include $generales->path_base.'templates/ubicaciones/_ubicacion_general.php' ?>
                    <?php include $generales->path_base.'templates/galeria/hogar-ketzaly/_galeria_hogar.php' ?>
                ...
                <div class="col-md-3">
                    ...
                    <a href='<?php echo $generales->url_base; ?>hogares/vista-impresion/vista-impresion-hogar-ketzaly.php' class="btn btn-primary color-primary btn-property btn-print">Vista de impresión</a>
