...
$descripcion_twitter = 'Espectacular oportunidad de terreno para inversión o para construir tu patrimonio en el, proyecto arquitectónico en coto exclusivo, espacio ideal para que tú y tu familia gocen al máximo,con medidas perfectas para desarrollar un proyecto arquitectónico ideal para vivir, tiene una excelente ubicación este bonito terreno en segunda sección de Ciudad Bugambilias, Zapopan, Jalisco.'; //falta por automatizar
?>
<!DOCTYPE html>
<html lang="en">
<head>
