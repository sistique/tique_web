...
$descripcion_twitter = 'Hogar kian es una bonita casa dentro de Coto Privado con acceso controlado en Jardines del Edén, en la zona Sur del Área Metropolitana de Guadalajara, el Inmueble cuenta con 2 niveles distribuida de la siguiente manera en planta baja se cuenta con Cochera, Sala, Comedor, Cocina Integral, 1/2 baño, patio.
En Planta Alta 2 recámaras, 1 baño completo, cuenta con una ubicación excepcional cerca de Av. Principales como son Av. Adolf B. Horn Jr, cercano a la nueva línea 4 del Tren Ligero.

Centros comerciales y tiendas de autoservicio a la mano Hogar kian se ubica se encuentra ubicado en El Fraccionamiento Jardínes del Edén del municipio de Tlajomulco de Zúñiga, Jalisco ideal para el bienestar de su familia por su tranquilidad y comodidad para poder vivir.
'?>
    <!DOCTYPE html>
    <html lang="en">
<head>
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="widget widget-box box-container widget-property">
                        <?php include $generales->path_base.'templates/sliders/hogar_kian/_slider_hogar_kian.php' ?>
                        <?php include $generales->path_base.'templates/descripcion/hogar-kian/_descripcion_hogar_kian.php' ?>
                    </div> <!-- /. widget-body -->
                    ...
                    <?php include $generales->path_base.'templates/galeria/hogar-kian/_galeria_hogar.php' ?>
                ...
                <div class="col-md-3">
                    ...
                    <a href='<?php echo $generales->url_base; ?>hogares/vista-impresion/vista-impresion-hogar-kian.php '<?php echo $url_landing_limpia?>' class="btn btn-primary color-primary btn-property btn-print">Vista de impresión</a>
