...
$descripcion_twitter = 'Hogar AZALEA excelente casa ubicada en una excelente zona al oriente de la Ciudad de Guadalajara Jalisco, en una colonia muy tranquila, la vivienda es ideal para el bienestar de su familia por su tranquilidad y comodidad para poder vivir, Hogar KETZALY cuenta con fácil acceso por su excelente ubicación a principales Avenidas de la Ciudad cómo son Av. José María Iglesias, y Av. Malecon, fácil acceso a escuelas, hospitales,  parques de recreación familiar y centros comerciales.

Hogar Azalea es una Casa Habitación de dos niveles que se distribuye de la siguiente manera, en la planta baja tenemos su Sala, Comedor, Cocina, ½ Baño, cuarto de lavado, estudio, patio/ jardín y cochera para 2 vehículos en la planta alta se cuenta con 3 recámaras con baño completo, pequeña sala de estar.
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="widget widget-box box-container widget-property">
                        <?php include $generales->path_base.'templates/sliders/hogar_azalea/_slider_hogar_azalea.php' ?>
                        <?php include $generales->path_base.'templates/descripcion/hogar-azalea/_descripcion_hogar_azalea.php' ?>
                    </div> <!-- /. widget-body -->
                    ...
                    <?php include $generales->path_base.'templates/galeria/hogar-azalea/_galeria_hogar.php' ?>
                ...
                <div class="col-md-3">
                    ...
                    <a href='<?php echo $generales->url_base; ?>hogares/vista-impresion/vista-impresion-hogar-azalea.php '<?php echo $url_landing_limpia?>' class="btn btn-primary color-primary btn-property btn-print">Vista de impresión</a>
