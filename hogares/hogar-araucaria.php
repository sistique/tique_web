            ...
            <section class="top-title">
                ...
                <div class="row">
                    <div class="col-md-12 pading_laterales_0 ">
                        ...
                        <div class="col-md-3">
                            <h3 class="label label-default oferta_hogar"></h3>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="widget widget-box box-container widget-property">
                        ...
                        <?php include $generales->path_base.'templates/descripcion/_descripcion_general_araucaria.php' ?>
                    </div> <!-- /. widget-body -->
                    ...
                    <?php include $generales->path_base.'templates/galeria/hogar-araucaria/_galeria_hogar.php' ?>
