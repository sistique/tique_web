                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="widget widget-box box-container widget-property">
                                ...
                                <?php include $generales->path_base.'templates/descripcion/_descripcion_general_teva.php' ?>
                            </div> <!-- /. widget-body -->
                            <?php include $generales->path_base.'templates/ubicaciones/_ubicacion_general.php' ?>
                            <?php include $generales->path_base.'templates/galeria/hogar-teva/_galeria_hogar.php' ?>
                        </div><!-- /.center-content -->
                        <div class="col-md-3">
