                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <select class="form-control selectpicker color-secondary" name="input" >
                                                <option value="0">Jobs By Company</option>
                                                <option value="1">ALDI STORES </option>
                                                <option value="2">Arnold Clark</option>
                                                <option value="3">Cambian Group</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <select class="form-control selectpicker color-secondary" name="input" >
                                                ...
                                                <option value="1">Engineering Jobs</option>
                                                <option value="2">Recruitment</option>
                                                <option value="3">Retail Jobs</option>
                                                <option value="3">Banking Jobs</option>
                                                <option value="3">Graduate Jobs</option>
                                                <option value="3">Marketing Jobs</option>
                                                <option value="3">Sales Jobs</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="h-side top-pad h-side-slim clearfix">
                                <div class="properties-filter">
                                    ...
                                    <div class="grid-type pull-right">
                                        <a href="index_job.html" class="grid active"><i class="fa fa-th"></i></a>
                                        ...
                                        <div class="property-card card  property-card-list row-fluid clearfix">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="property-card-box card-box card-block">
                                                    <h3 class="property-card-title"><a href="listing.html">Operator</a></h3>
                                                    ...
                                                    <div class="property-preview-footer  clearfix">
                                                        ...
                                                        <div class="property-preview-f-left aux-info text-color-primary">
                                                            <span class="property-card-value">
                                                                <i class="fa fa-calendar"></i><strong>Date:</strong> 17 July
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-user"></i><strong>Jobs:</strong> 37 Jobs
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-globe"></i><strong>City:</strong> London
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="property-card card  property-card-list row-fluid clearfix">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="property-card-box card-box card-block">
                                                    <h3 class="property-card-title"><a href="listing.html">Car service</a></h3>
                                                    <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div>
                                                    <div class="property-preview-footer  clearfix">
                                                        <div class="property-preview-f-right">
                                                            <a href="listing.html" class="btn btn-details text-uppercase">view details</a>
                                                        ...
                                                        <div class="property-preview-f-left aux-info text-color-primary">
                                                            <span class="property-card-value">
                                                                <i class="fa fa-calendar"></i><strong>Date:</strong> 18 July
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-user"></i><strong>Jobs:</strong> 36 Jobs
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-globe"></i><strong>City:</strong> London
                                                            </span>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="property-card card  property-card-list row-fluid clearfix">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="property-card-box card-box card-block">
                                                    <h3 class="property-card-title"><a href="listing.html">Writer</a></h3>
                                                    <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div>
                                                    <div class="property-preview-footer  clearfix">
                                                        <div class="property-preview-f-right">
                                                            <a href="listing.html" class="btn btn-details text-uppercase">view details</a>
                                                        ...
                                                        <div class="property-preview-f-left aux-info text-color-primary">
                                                            <span class="property-card-value">
                                                                <i class="fa fa-calendar"></i><strong>Date:</strong> 14 July
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-user"></i><strong>Jobs:</strong> 21 Jobs
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-globe"></i><strong>City:</strong> London
                                                            </span>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="property-card card  property-card-list row-fluid clearfix">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="property-card-box card-box card-block">
                                                    <h3 class="property-card-title"><a href="listing.html">Waiter</a></h3>
                                                    <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div>
                                                    <div class="property-preview-footer  clearfix">
                                                        <div class="property-preview-f-right">
                                                            <a href="listing.html" class="btn btn-details text-uppercase">view details</a>
                                                        ...
                                                        <div class="property-preview-f-left aux-info text-color-primary">
                                                            <span class="property-card-value">
                                                                <i class="fa fa-calendar"></i><strong>Date:</strong> 20 July
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-user"></i><strong>Jobs:</strong> 143 Jobs
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-globe"></i><strong>City:</strong> London
                                                            </span>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="property-card card  property-card-list row-fluid clearfix">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="property-card-box card-box card-block">
                                                    <h3 class="property-card-title"><a href="listing.html">Recruitment</a></h3>
                                                    <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div>
                                                    <div class="property-preview-footer  clearfix">
                                                        <div class="property-preview-f-right">
                                                            <a href="listing.html" class="btn btn-details text-uppercase">view details</a>
                                                        ...
                                                        <div class="property-preview-f-left aux-info text-color-primary">
                                                            <span class="property-card-value">
                                                                <i class="fa fa-calendar"></i><strong>Date:</strong> 7 July
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-user"></i><strong>Jobs:</strong> 344 Jobs
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-globe"></i><strong>City:</strong> London
                                                            </span>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="property-card card  property-card-list row-fluid clearfix">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="property-card-box card-box card-block">
                                                    <h3 class="property-card-title"><a href="listing.html">Hair cut</a></h3>
                                                    <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div>
                                                    <div class="property-preview-footer  clearfix">
                                                        <div class="property-preview-f-right">
                                                            <a href="listing.html" class="btn btn-details text-uppercase">view details</a>
                                                        ...
                                                        <div class="property-preview-f-left aux-info text-color-primary">
                                                            <span class="property-card-value">
                                                                <i class="fa fa-calendar"></i><strong>Date:</strong> 22 July
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-user"></i><strong>Jobs:</strong> 23 Jobs
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-globe"></i><strong>City:</strong> London
                                                            </span>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="property-card card  property-card-list row-fluid clearfix">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="property-card-box card-box card-block">
                                                    <h3 class="property-card-title"><a href="listing.html">Engineering Jobs</a></h3>
                                                    <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div>
                                                    <div class="property-preview-footer  clearfix">
                                                        <div class="property-preview-f-right">
                                                            <a href="listing.html" class="btn btn-details text-uppercase">view details</a>
                                                        ...
                                                        <div class="property-preview-f-left aux-info text-color-primary">
                                                            <span class="property-card-value">
                                                                <i class="fa fa-calendar"></i><strong>Date:</strong> 6 July
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-user"></i><strong>Jobs:</strong> 134 Jobs
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-globe"></i><strong>City:</strong> London
                                                            </span>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="property-card card  property-card-list row-fluid clearfix">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="property-card-box card-box card-block">
                                                    <h3 class="property-card-title"><a href="listing.html">Software developer</a></h3>
                                                    <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div>
                                                    <div class="property-preview-footer  clearfix">
                                                        <div class="property-preview-f-right">
                                                            <a href="listing.html" class="btn btn-details text-uppercase">view details</a>
                                                        ...
                                                        <div class="property-preview-f-left aux-info text-color-primary">
                                                            <span class="property-card-value">
                                                                <i class="fa fa-calendar"></i><strong>Date:</strong> 21 July
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-user"></i><strong>Jobs:</strong> 43 Jobs
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-globe"></i><strong>City:</strong> London
                                                            </span>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="property-card card  property-card-list row-fluid clearfix">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="property-card-box card-box card-block">
                                                    <h3 class="property-card-title"><a href="listing.html">Reality expert</a></h3>
                                                    <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div>
                                                    <div class="property-preview-footer  clearfix">
                                                        <div class="property-preview-f-right">
                                                            <a href="listing.html" class="btn btn-details text-uppercase">view details</a>
                                                        ...
                                                        <div class="property-preview-f-left aux-info text-color-primary">
                                                            <span class="property-card-value">
                                                                <i class="fa fa-calendar"></i><strong>Date:</strong> 23 July
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-user"></i><strong>Jobs:</strong> 73 Jobs
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-globe"></i><strong>City:</strong> London
                                                            </span>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="property-card card  property-card-list row-fluid clearfix">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="property-card-box card-box card-block">
                                                    <h3 class="property-card-title"><a href="listing.html">Restourants job</a></h3>
                                                    <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div>
                                                    <div class="property-preview-footer  clearfix">
                                                        <div class="property-preview-f-right">
                                                            <a href="listing.html" class="btn btn-details text-uppercase">view details</a>
                                                        ...
                                                        <div class="property-preview-f-left aux-info text-color-primary">
                                                            <span class="property-card-value">
                                                                <i class="fa fa-calendar"></i><strong>Date:</strong> 24 July
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-user"></i><strong>Jobs:</strong> 33 Jobs
                                                            </span>
                                                            <span class="property-card-value">
                                                                <i class="fa fa-globe"></i><strong>City:</strong> London
                                                            </span>
                        ...
                        <div class="col-md-3 sidebar-right">
                            ...
                            <div class="widget widget-box  box-container">
                                <div class="widget-header text-uppercaser">Most Wanted</div>
                                <ul class="widget-list text-uppercase text-center npad">
                                    <li><a href="#" class="widget-item">SKIPPER IN SPLIT</a></li>
                                    <li><a href="#" class="widget-item">FRONTEND DEVELOPER IN VARAZDIN</a></li>
                                    <li><a href="#" class="widget-item">NANNY IN ZAGORJE</a></li>
                                </ul>
                            </div><!-- /.widget-filter--> 
