                            ...
                            <div class="h-side top-pad h-side-slim clearfix">
                                <div class="properties-filter">
                                    ...
                                    <div class="grid-type pull-right">
                                        <a href="slider_standard_rtl.html" class="grid active"><i class="fa fa-th"></i></a>
                        ...
                        <div class="col-md-3 sidebar-right">
                            ...
                            <div class="widget widget-box  box-container">
                                ...
                                <div class="form-additional">
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-primary btn-wide color-primary" type='submit'><span>Refresh results</span></button>
                                    </div>
                                </div>
                            </div>
                            <div class="widget widget-box box-container">
