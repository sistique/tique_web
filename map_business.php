                            ...
                            <div class="h-side top-pad h-side-slim clearfix">
                                <div class="properties-filter">
                                    ...
                                    <div class="grid-type pull-right">
                                        <a href="map_business.html" class="grid active"><i class="fa fa-th"></i></a>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-6">
                                        <div class="property-card card">
                                            ...
                                            <div class="property-card-tags">
                                                <span class="label label-default label-tag-warning">food drink</span>
                                            </div>
                                            <div class="property-card-box card-box card-block">
                                                <h3 class="property-card-title"><a href="listing.html">Caffe bar</a></h3>
                                                ...
                                                <div class="property-preview-footer  clearfix">
                                                    <div class="property-preview-f-left text-color-primary">
                                                        <span class="property-card-value">
                                                            <i class="fa fa-map-marker"></i>200m
                                                        </span>
                                                        <span class="property-card-value">
                                                            <i class="fa fa-car"></i>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="property-card card">
                                            ...
                                            <div class="property-card-tags">
                                                <span class="label label-default label-tag-primary">food drink</span>
                                            </div>
                                            <div class="property-card-box card-box card-block">
                                                <h3 class="property-card-title"><a href="listing.html">Home food restaurant</a></h3>
                                                <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div>
                                                <div class="property-preview-footer  clearfix">
                                                    <div class="property-preview-f-left text-color-primary">
                                                        <span class="property-card-value">
                                                            <i class="fa fa-map-marker"></i>120m
                                                        </span>
                                                        <span class="property-card-value">
                                                            <i class="fa fa-car"></i>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="property-card card">
                                            ...
                                            <div class="property-card-tags">
                                                <span class="label label-default label-tag-primary">shopping</span>
                                            </div>
                                            <div class="property-card-box card-box card-block">
                                                <h3 class="property-card-title"><a href="listing.html">Flower shop</a></h3>
                                                <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div>
                                                <div class="property-preview-footer  clearfix">
                                                    <div class="property-preview-f-left text-color-primary">
                                                        <span class="property-card-value">
                                                            <i class="fa fa-map-marker"></i>20m
                                                        </span>
                                                        <span class="property-card-value">
                                                            <i class="fa fa-car"></i>
                                                            <i class="fa fa-check"></i>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="property-card card">
                                            ...
                                            <div class="property-card-box card-box card-block">
                                                <h3 class="property-card-title"><a href="listing.html">Bakery</a></h3>
                                                <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div>
                                                <div class="property-preview-footer  clearfix">
                                                    <div class="property-preview-f-left text-color-primary">
                                                        <span class="property-card-value">
                                                            <i class="fa fa-map-marker"></i>400m
                                                        </span>
                                                        <span class="property-card-value">
                                                            <i class="fa fa-car"></i>
                                                            <i class="fa fa-check"></i>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="property-card card">
                                            ...
                                            <div class="property-card-box card-box card-block">
                                                <h3 class="property-card-title"><a href="listing.html">Clothes shop</a></h3>
                                                <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div>
                                                <div class="property-preview-footer  clearfix">
                                                    <div class="property-preview-f-left text-color-primary">
                                                        <span class="property-card-value">
                                                            <i class="fa fa-map-marker"></i>150m
                                                        </span>
                                                        <span class="property-card-value">
                                                            <i class="fa fa-car"></i>
                                                            <i class="fa fa-check"></i>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="property-card card">
                                            ...
                                            <div class="property-card-tags">
                                                <span class="label label-default label-tag-primary">services</span>
                                            </div>
                                            <div class="property-card-box card-box card-block">
                                                <h3 class="property-card-title"><a href="listing.html">Car vulkanizer</a></h3>
                                                <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div>
                                                <div class="property-preview-footer  clearfix">
                                                    <div class="property-preview-f-left text-color-primary">
                                                        <span class="property-card-value">
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="property-card card">
                                            ...
                                            <div class="property-card-box card-box card-block">
                                                <h3 class="property-card-title"><a href="listing.html">Fast food eko restourand</a></h3>
                                                <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div>
                                                <div class="property-preview-footer  clearfix">
                                                    <div class="property-preview-f-left text-color-primary">
                                                        <span class="property-card-value">
                                                            <i class="fa fa-map-marker"></i>250m
                                                        </span>
                                                        <span class="property-card-value">
                                                            <i class="fa fa-car"></i>
                                                            <i class="fa fa-check"></i>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="property-card card">
                                            ...
                                            <div class="property-card-box card-box card-block">
                                                <h3 class="property-card-title"><a href="listing.html">Luxar Hotel</a></h3>
                                                <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div>
                                                <div class="property-preview-footer  clearfix">
                                                    <div class="property-preview-f-left text-color-primary">
                                                        <span class="property-card-value">
                                                            <i class="fa fa-map-marker"></i>210m
                                                        </span>
                                                        <span class="property-card-value">
                                                            <i class="fa fa-car"></i>
                                                            <i class="fa fa-check"></i>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="property-card card">
                                            ...
                                            <div class="property-card-box card-box card-block">
                                                <h3 class="property-card-title"><a href="listing.html">Photo expert</a></h3>
                                                <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div>
                                                <div class="property-preview-footer  clearfix">
                                                    <div class="property-preview-f-left text-color-primary">
                                                        <span class="property-card-value">
                                                            <i class="fa fa-map-marker"></i>800m
                                                        </span>
                                                        <span class="property-card-value">
                                                            <i class="fa fa-car"></i>
                                                            <i class="fa fa-times"></i>
                        ...
                        <div class="col-md-3 sidebar-right">
                            ...
                            <div class="widget widget-box box-container">
                                ...
                                <ul class="widget-list text-uppercase text-center npad">
                                    <li><a href="#" class="widget-item">boat rent IN SPLIT</a></li>
                                    <li><a href="#" class="widget-item">Hotel IN VARAZDIN</a></li>
                                    <li><a href="#" class="widget-item">restourant IN ZAGORJE</a></li>
                                </ul>
                            </div><!-- /.widget-filter--> 
