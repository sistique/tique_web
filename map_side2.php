...
<<<<<<< HEAD
<<<<<<< HEAD:map_side2.php
                                            <a href="map_side.php" class="grid active"><i class="fa fa-th"></i></a>
=======
                                            <a href="map_side.html" class="grid active"><i class="fa fa-th"></i></a>
>>>>>>> d985c97835bb2b534e9667a7ba1d2495f666e8b4:map_side.php
=======
                                            <a href="map_side.php" class="grid active"><i class="fa fa-th"></i></a>
>>>>>>> d985c97835bb2b534e9667a7ba1d2495f666e8b4
                                            <a href="map_side_list.php" class="list"><i class="fa fa-list"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- /. content-header --> 
...
>>>>>>> d985c97835bb2b534e9667a7ba1d2495f666e8b4
                                            ...
                                            <div class="property-card-box card-box card-block">
                                                <h3 class="property-card-title"><a href="listing.html">Backyard with pool</a></h3>
                                                <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div>
                                                <div class="property-preview-footer  clearfix">
                                                    <div class="property-preview-f-left text-color-primary">
                                                        <span class="property-card-value">
