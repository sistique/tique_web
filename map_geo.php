...
<html lang="en">
    ...
    <body class="">
        ...
        <div class="container container-wrapper">
            ...
            <section class="section section-color-primary" id="widget-region">
                <h3 class="hidden">Map geo</h3>
                <div class="container clearfix">
                    <div class="worldmapgenerator"></div>
                </div>
            </section><!-- /.header-map-region-->
                    ...
                    <div class="row">
                            ...
                            <div class="h-side top-pad h-side-slim clearfix">
                                <div class="properties-filter">
                                    ...
                                    <div class="grid-type pull-right">
                                        <a href="map_geo.html" class="grid active"><i class="fa fa-th"></i></a>
                        ...
                        <div class="col-md-3 sidebar-right">
                            ...
                            <div class="widget widget-box  box-container">
                                <div class="tags-cloud text-color-primary text-center">
                                    <a href='map_geo.html?geolocation=amsterdam' class="tag-sm">Amsterdam</a>
                                    <a href='map_geo.html?geolocation=budapest' class="tag-sm">Budapest</a>
                                    <a href='map_geo.html?geolocation=london' class="tag-lg">London</a>
                                    <a href='map_geo.html?geolocation=madrid' class="tag-sm">Madrid</a>
                                    <a href='map_geo.html?geolocation=malta' class="tag-sm">Malta</a>
                                    <a href='map_geo.html?geolocation=dublin' class="tag-lg">Dublin</a>
                                    <a href='map_geo.html?geolocation=oslo' class="tag-sm">Oslo</a>
                                    <a href='map_geo.html?geolocation=paris' class="tag-lg">Paris</a>
                                    <a href='map_geo.html?geolocation=berlin' class="tag-xs">Berlin</a>
                                    <a href='map_geo.html?geolocation=madrid' class="tag-sm">Madrid</a>
                                    <a href='map_geo.html?geolocation=rome' class="tag-xs">Rome</a>
                                    <a href='map_geo.html?geolocation=moscow' class="tag-xs">Moscow</a>
                                    <a href='map_geo.html?geolocation=vienna' class="tag-lg-4">Vienna</a>
                                    <a href='map_geo.html?geolocation=minsk' class="tag-md">Minsk</a>
                                    <a href='map_geo.html?geolocation=barcelona' class="tag-md">Barcelona</a>
                                    <a href='map_geo.html?geolocation=milan' class="tag-md">Milan</a>
                                    <a href='map_geo.html?geolocation=prague' class="tag-lg">Prague</a>
                                    <a href='map_geo.html?geolocation=brussels' class="tag-lg">Brussels</a>
                                    <a href='map_geo.html?geolocation=liverpool' class="tag-sm">Liverpool</a>
                                    <a href='map_geo.html?geolocation=dortmund' class="tag-sm">Dortmund</a>
                                    <a href='map_geo.html?geolocation=lisbon' class="tag-sm">Lisbon</a>
                                    <a href='map_geo.html?geolocation=dublin' class="tag-sm">Dublin</a>
                                    <a href='map_geo.html?geolocation=prague' class="tag-lg-4">Prague</a>
                                    <a href='map_geo.html?geolocation=riga' class="tag-sm">Riga</a>
                                    <a href='map_geo.html?geolocation=sofia' class="tag-lg-2">Sofia</a>
                                    <a href='map_geo.html?geolocation=vilnius' class="tag-xs">Vilnius</a>
                                    <a href='map_geo.html?geolocation=warsaw' class="tag-lg-3">Warsaw</a>
                                    <a href='map_geo.html?geolocation=zagreb' class="tag-xs">Zagreb</a>
                                </div>
                            </div><!-- /.widget-filter--> 
