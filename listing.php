            ...
            <main class="main section-color-primary">
                <div class="container">
                    <section class="top-title">
                        ...
                        <h1 class="h-side-title page-title page-title-big text-color-primary">Black glass house</h1> 
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="widget widget-box box-container widget-overview visible-sm visible-xs">
                                ...
                                <ul class="list-overview">
                                    ...
                                    <li>
                                        ...
                                        <span class="list-overview-value">80 kWh EP / m<sup><small>2</small></sup></span>
                                    </li>
                                    <li>
                                        <span class="list-overview-option">Gas emissions: </span>
                                        <span class="list-overview-value">30 kg CO2 / m<sup><small>2</small></sup></span>
                                    </li>
                                    <li>
                            ...
                            <div class="widget widget-box box-container widget-property-map">
                                ...
                                <div class="places_select">
                                    <a class="btn btn-large" data-rel="hospital,health"><img src="assets/img/places_icons/hospital.png" alt='hospital,health'/> Health</a>
                                    <a class="btn btn-large" data-rel="park"><img src="assets/img/places_icons/park.png" alt='park' /> Park</a>
                                    <a class="btn btn-large" data-rel="atm,bank"><img src="assets/img/places_icons/atm.png" alt='atm'/> ATMBank</a>
                                    <a class="btn btn-large" data-rel="gas_station"><img src="assets/img/places_icons/petrol.png" alt="gas_station"/> PetrolPump</a>
                                    <a class="btn btn-large" data-rel="food,bar,cafe,restourant"><img src="assets/img/places_icons/restourant.png" alt="food" /> Restourant</a>
                                    <a class="btn btn-large" data-rel="store"><img src="assets/img/places_icons/store.png" alt="store"/> Store</a>
                                </div>
                            ...
                            <div class="widget widget-box box-container">
                                ...
                                <div class="fb-comments" data-href="http://realsite.winter-flat-html.com//comments" data-width="100%" data-numposts="5" data-colorscheme="light"></div>
                            </div><!-- /. widget-facebook -->    
                        </div><!-- /.center-content -->
                        <div class="col-md-3">
                            <div class="widget widget-box box-container widget-overview hidden-sm  hidden-xs">
                                ...
                                <ul class="list-overview">
                                    <li class="custom-address">
                                        <span class="list-overview-option">Address</span>
                                        <span class="list-overview-value" title="Vatikanska 11, Zagreb">Vatikanska 11, Zagreb</span>
                                    </li>
                                    <li>
                                        <span class="list-overview-option">Purpose: </span>
                                        <span class="list-overview-value"><span class="label label-default label-tag-primary">sale</span></span>
                                    ...
                                    <li class="custom-en">
                                        <span class="list-overview-option">Energy efficient:</span>
                                        <span class="list-overview-value" title="80 kWh EP / m">80 kWh EP / m<sup><small>2</small></sup></span>
                                    </li>
                                    <li  class="custom-en">
                                        <span class="list-overview-option">Gas emissions: </span>
                                        <span class="list-overview-value"  title="30 kg CO2 / m">30 kg CO2 / m<sup><small>2</small></sup></span>
                                    </li>
                                    <li>
                                        <span class="list-overview-option">Views Counter: 	 </span>
                                        <span class="list-overview-value">15119</span>
                            ...
                            <a href='listing_print.php' class="btn btn-primary color-primary btn-property btn-print">Print Version</a>
                                ...
                                <form action="#" method="post">
                                    <div class="box-container widget-body">
                                        ...
                                        <div class="form-additional">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name='address' class="form-control" placeholder="Addrese"  />
                                            </div>
                                            <div class="form-group">
