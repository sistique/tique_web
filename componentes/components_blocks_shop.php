...
<html lang="en">
    <head>
        <meta charset="UTF-8" />
        <title>Components Property Blocks</title>
                ...
                <div class="container">
                    <section class="top-title">
                        <ul class="breadcrumb">
                            ...
                            <li class="item"> Blocks Shop </li>
                        </ul>
                        <h1 class="h-side-title page-title page-title-big text-color-primary">Blocks Shop</h1> 
                        ...
                        <div class="col-md-9 components-examples">
                            <section class="widget widget-box  box-container">
                                ...
                                <div class="bd-example row">
                                    <div class="col-md-4">
                                        <div class="property-card card shop-card properties-border">
                                ...
                                <textarea name="input" class="file_content" cols="30" rows="10">
                                    <div class="property-card card shop-card properties-border"> 
                                        ...
                                        <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div> 
                                            <div class="property-preview-footer clearfix">
                                                <div class="property-preview-f-right">
                                                    <a href="page_cart.html" class="btn btn-sm btn-base btn-icon btn-cart pull-right"> 
                                                        <span>Add to cart</span> 
                                                    </a> 
                                                </div> 
                                                <div class="property-preview-f-left text-color-primary"> 
                            ...
                            <section class="widget widget-box">
                                <div class="box-container-title">
                                    <h2 class="title widget-header">Examples #2</h2> 
                                </div>
                                <div class="bd-example row">
                                    <div class="col-md-4">
                                        <div class="property-card card shop-card properties-border">
                            ...
                            <div class="widget widget-box box-container widget-list-menu">
                                ...
                                <div class="">
                                    <ul class="categories list-menu">
                                        ...
                                        <li><a class="dropdown-item active" href="#">Blocks</a>
                                            <ul>
                                                ...
                                                <li><a href="components_blocks_shop.html">Blocks Shop</a></li>
                                            </ul>
                                        </li>
