...
<html lang="en">
    <head>
        <meta charset="UTF-8" />
        <title>Components Breadcrumb</title>
            ...
            <main class="main section-color-primary">
                <div class="container">
                    <section class="top-title">
                        ...
                        <h1 class="h-side-title page-title page-title-big text-color-primary">Breadcrumb</h1> 
                        ...
                        <div class="col-md-9 components-examples">
                            <section class="widget widget-box  box-container">
                                <div class="box-container-title">
                                    ...
                                    <span class="sub-title">Indicate the current page's location within a navigational hierarchy.</span>
                                </div>
                            ...
                            <div class="widget widget-box box-container widget-list-menu">
                                ...
                                <div class="">
                                    <ul class="categories list-menu">
                                        ...
                                        <li><a class="dropdown-item active" href="component_breadcrumb.html">Breadcrumb</a></li>
