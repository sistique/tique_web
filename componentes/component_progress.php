...
<html lang="en">
    <head>
        <meta charset="UTF-8" />
        <title>Components Progress Bar</title>
                ...
                <div class="container">
                    <section class="top-title">
                        <ul class="breadcrumb">
                            ...
                            <li class="item"> Progress Bars </li>
                        </ul>
                        <h1 class="h-side-title page-title page-title-big text-color-primary">Progress Bars</h1> 
                    ...
                    <div class="row">
                        <div class="col-md-9 components-examples">
                            ...
                            <section class="widget widget-box  box-container">
                                <div class="box-container-title">
                                    <h2 class="title widget-header">Striped</h2> 
                            ...
                            <div class="widget widget-box box-container widget-list-menu">
                                ...
                                <div class="">
                                    <ul class="categories list-menu">
                                        ...
                                        <li><a class="dropdown-item active" href="component_progress.html">Progress Bars</a></li>
