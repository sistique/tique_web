...
<html lang="en">
    <head>
        <meta charset="UTF-8" />
        <title>Components Property Blocks List</title>
                ...
                <div class="container">
                    <section class="top-title">
                        <ul class="breadcrumb">
                            ...
                            <li class="item"> Blocks Property List </li>
                        </ul>
                        <h1 class="h-side-title page-title page-title-big text-color-primary">Blocks Property List</h1> 
                                    ...
                                    <div class="property-card card  property-card-list row-fluid clearfix"> 
                                            ...
                                            <div class="col-sm-8"> 
                                                ...
                                                <div class="property-card-descr">This is simply dummy text of the printing and typesetting industry. That has been the industry standard ...</div> 
                                                    <div class="property-preview-footer clearfix">
                                                        <div class="property-preview-f-right">
                                                            <a href="page_cart.html" class="btn btn-details text-uppercase"> 
                                    ...
                                    <ul class="categories list-menu">
                                        ...
                                        <li><a class="dropdown-item active" href="#">Blocks</a>
                                            <ul>
                                                ...
                                                <li><a href="components_blocks_propertylist.html">Blocks Property List</a></li>
