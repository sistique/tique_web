...
<html lang="en">
    <head>
        <meta charset="UTF-8" />
        <title>Components Carousel Owl</title>
                ...
                <div class="container">
                    <section class="top-title">
                        <ul class="breadcrumb">
                            ...
                            <li class="item"> Carousels owl </li>
                        </ul>
                        <h1 class="h-side-title page-title page-title-big text-color-primary">Carousels owl</h1> 
                                ...
                                <textarea name="input" class="file_content" cols="30" rows="10">
                                    <div class="col-md-12 col-md-offset-0 owl-corousel-box agencies-corousel">
                                        <div class="owl-carousel"> 
                                            <div class="item"> 
                                                <a href="#">
                                                    <img src="assets/img/placeholders/300x60.png" alt="" />
                                                </a> </div> 
                                            <div class="item"> 
                                                <a href="#">
                                                    <img src="assets/img/placeholders/300x60.png" alt="" />
                                        ...
                                        <a href="#" class="owl-btn customPrevBtn">
                                        </a>
                                        <a href="#" class="owl-btn customNextBtn">
                                        </a> 
                                    </div>
                                </textarea>
                            </section>
                                    ...
                                    <ul class="categories list-menu">
                                        ...
                                        <li><a class="dropdown-item active" href="#">Carousels</a>
                                            <ul>
                                                ...
                                                <li><a href="component_carousel_owl.html">Carousels owl</a></li>
                                            </ul>
                                        </li>
